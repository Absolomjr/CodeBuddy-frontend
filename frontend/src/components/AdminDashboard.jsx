...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      {/* Modal for Add/Edit */}
      {showModal && (
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-2xl">
          <div className="bg-white rounded-xl shadow-2xl p-10 w-full relative border border-gray-300">
            <button
